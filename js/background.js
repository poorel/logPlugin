...
chrome.webRequest.onCompleted.addListener( (a,b) => {
	console.log(a,b)

}, {urls: ["<all_urls>"]}, []);
chrome.webRequest.onResponseStarted.addListener( (a,b) => {
	console.log(a,b,123)

}, {urls: ["<all_urls>"]}, []);
chrome.webRequest.onHeadersReceived.addListener( (a,b) => {
	console.log(a,b,555)

}, {urls: ["<all_urls>"]}, []);
chrome.webRequest.onBeforeSendHeaders.addListener(
	function (details) {
		console.log(details,88)
	},
	{ urls: ["<all_urls>"]}
);
...
s$(document).ajaxComplete(function (e) {
	...
	if (details.responseText == "") {
		console.log('异常刷新');//location.reload();
	}
